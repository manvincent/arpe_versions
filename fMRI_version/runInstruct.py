...
def runInstruct(expInfo, dispInfo, taskInfo, taskObj, keyInfo):
    imagePath = f'{expInfo.instructDir}/pages'
    ...
    instructObj = InstructPages(dispInfo, taskInfo, taskObj, imagePath, instruct_maxRT)
    currPage = 1
    while True:
...
class InstructPages(object):
    def __init__(self, dispInfo, taskInfo, taskObj, imagePath, instruct_maxRT):
